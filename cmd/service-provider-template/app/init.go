...
func (o *InitOptions) initWebhooks(ctx context.Context, onboardingCluster *clusters.Cluster, providerSystemNamespace string) error {
	...
	// Note that the secret has to follow the naming convetion of the openmcp-operator (https://github.com/openmcp-project/openmcp-operator)
	// provider deployment to be picked up automatically.
